...
### "redirect_uri is not associated with this application" warning

This warning appears when the GitHub OAuth app doesn't have the redirect URI configured. To fix:
